...
export function downloadExcelFile(params: DownloadParams, filename = "slist.xlsx") {
  ...
  const downloadUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/slistexcel-download?${queryString}`;
