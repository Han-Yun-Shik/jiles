...
export function downloadExcelFile(params: DownloadParams, filename = "sjlist.xlsx") {
  ...
  const downloadUrl = `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/sjlistexcel-download?${queryString}`;
